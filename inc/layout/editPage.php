          ...
          <div class="row-fluid span12" id="editPageBlock">
            ...
            <div class="row-fluid">
              <div class="span6">
                ...
                <textarea class="span12" id="jwsy" name="content" style="width:100%;" maxlength="100000"><?php echo htmlspecialchars( $results['page']->content ); ?></textarea>
              </div>
            </div>              
            <div class="row-fluid">
              <div class="span6">
            ...
            <div class="row-fluid span6" style="margin:0 0 10px 0;">
