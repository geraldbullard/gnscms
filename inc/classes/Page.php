...
class Page {
  ...
  */
  ...
  public function insert() {
    ...
    // Insert the Page
    $conn = new PDO( DB_DSN, DB_USERNAME, DB_PASSWORD );
    $sql = "INSERT INTO " . DB_PREFIX . "pages ( title, slug, summary, content, metaDescription, metaKeywords, sort, status, parent, siteIndex, botAction ) VALUES ( :title, :slug, :summary, :content, :metaDescription, :metaKeywords, :sort, :status, :parent, :siteIndex, :botAction )";
    $st = $conn->prepare ( $sql );
  ...
  */
  ...
  public function update() {
    ...
    // Update the Page
    $conn = new PDO( DB_DSN, DB_USERNAME, DB_PASSWORD );
    $sql = "UPDATE " . DB_PREFIX . "pages SET title = :title, slug = :slug, summary = :summary, content = :content, metaDescription = :metaDescription, metaKeywords = :metaKeywords, sort = :sort, status = :status, parent = :parent, siteIndex = :siteIndex, botAction = :botAction WHERE id = :id";
    $st = $conn->prepare ( $sql );
