    ...
    <div class="row-fluid">
      <div class="box span12">
        ...
        <div class="box-content">
          <?php if (isset($results['errorMessage']) || isset($results['successMessage']) || isset($results['warningMessage']) || isset($results['infoMessage'])) { ?>
          <div>
                ...
                <fieldset>
                  ...
                  <div class="row-fluid">
                    <div class="span6">
                      ...
                      <input class="span12" type="text" id="slug" name="slug" />
                    </div>
                  </div>
                  <div class="row-fluid">
                    <div class="span6">
                      <label>Page Summary</label>
                      <input class="span12" class="text-input medium-input" type="text" id="summary" name="summary" />
                    </div>
                  </div>
                  <div class="row-fluid">
                    <div class="span6">
                      <label>Page Content</label>
                      <textarea class="text-input textarea span12" name="content" id="content" /></textarea>
                    </div>
                  </div>
                  <div class="row-fluid">
                    <div class="span6">
                      <label>Meta Description</label>
                      <textarea class="text-input textarea span12" id="metaDescription" name="metaDescription" /></textarea>
                    </div>
                  </div>
                  <div class="row-fluid">
                    <div class="span6">
                      <label>Meta Keywords</label>
                      <textarea class="text-input textarea span12" id="metaKeywords" name="metaKeywords" /></textarea>
                    </div>
                  </div>
                  <div class="row-fluid">
                    <div class="span6">
