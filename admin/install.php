          ...
          if (@mysql_select_db($database_name)) {
            if (@mysql_query("DROP TABLE IF EXISTS " . DB_PREFIX . "content") != 0 &&
                @mysql_query("CREATE TABLE IF NOT EXISTS " . DB_PREFIX . "content (id smallint(5) unsigned NOT NULL AUTO_INCREMENT,
                                                                                   ...
                                                                                   ENGINE=MyISAM DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci AUTO_INCREMENT=10;") != 0 &&
                ...
                @mysql_query("CREATE TABLE IF NOT EXISTS " . DB_PREFIX . "settings (id smallint(5) unsigned NOT NULL AUTO_INCREMENT,
                                                                                    ...
                                                                                    PRIMARY KEY (id, title)) 
                                                                                    ENGINE=MyISAM DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci AUTO_INCREMENT=13;") != 0 &&
                ...
                @mysql_query("CREATE TABLE IF NOT EXISTS " . DB_PREFIX . "users (id smallint(5) unsigned NOT NULL AUTO_INCREMENT,
                                                                                 ...
                                                                                 usergroup smallint(5) unsigned NOT NULL DEFAULT '1',
                                                                                 status tinyint(1) unsigned NOT NULL DEFAULT '1',
                                                                                 PRIMARY KEY (id, username)) 
                                                                                 ENGINE=MyISAM DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci AUTO_INCREMENT=2;") != 0 && 
                @mysql_query("DROP TABLE IF EXISTS " . DB_PREFIX . "groups") != 0 &&
                @mysql_query("CREATE TABLE IF NOT EXISTS " . DB_PREFIX . "groups (id smallint(5) unsigned NOT NULL AUTO_INCREMENT,
