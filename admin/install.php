        ...
        if (@mysql_connect($database_host, $database_username, $database_password)) {
          if (@mysql_select_db($database_name)) {
            if (@mysql_query("DROP TABLE IF EXISTS " . DB_PREFIX . "pages") !=0 &&
                ...
                @mysql_query("INSERT INTO " . DB_PREFIX . "pages (id, title, slug, summary, content, metaDescription, metaKeywords, sort, status, parent, siteIndex, botAction, menu) VALUES 
                                                                 ...
                                                                 (9, '404', '404', '404 Page Missing', '<p>Well this is embarrassing...</p>', '', '', 9999, 1, 0, 0, 'noindex, nofollow', 0);") &&
