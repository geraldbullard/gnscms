        ...
        if (@mysql_connect($database_host, $database_username, $database_password)) {
          if (@mysql_select_db($database_name)) {
            if (@mysql_query("DROP TABLE IF EXISTS " . DB_PREFIX . "content") != 0 &&
                ...
                @mysql_query("DROP TABLE IF EXISTS " . DB_PREFIX . "access") != 0 &&
                @mysql_query("CREATE TABLE IF NOT EXISTS " . DB_PREFIX . "access (id smallint(5) unsigned NOT NULL AUTO_INCREMENT,
                                                                                  name varchar(128) COLLATE utf8_unicode_ci NOT NULL,
                ...
                @mysql_query("INSERT INTO " . DB_PREFIX . "groups (id, name, status) VALUES 
