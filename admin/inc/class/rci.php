<?php
  class gns_admin_RCI {
    ...
    function gns_admin_RCI() {
      if (!isset($_SESSION['gns_admin_RCI_data'])) {
        $_SESSION['gns_admin_RCI_data'] = array('folders' => array() );
      }
      $this->_folders = $_SESSION['gns_admin_RCI_data']['folders'];
    }
